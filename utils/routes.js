export const ROUTES = {
  ...
  PARKING_TICKETS: {
    ...
    DELTE_TICEKT_BY_ID: "/parking-tickets/delete/:ticketId",
    RESTORE_TICEKT_BY_ID: "/parking-tickets/restore/:ticketId",
    GET_ALL_DELETED_TICKETS: "/admin/parking-tickets/deleted",
  },
  SITE: {
    CREATE: "/create-site",
